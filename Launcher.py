...
class AlwaysOnTopApp:  # Define a classe AlwaysOnTopApp
    ...
    def check_exit(self, event):
        try:
            ...
            if command == "exit":
                ...
                self.execute_command(command)  # Executa o comando
        except Exception as e:
    ...
    def expand_app(self, labelText="Novo Valor:"):  # Define o rótulo padrão como "Novo Valor:"
        try:
            ...
            new_entry.bind("<Return>", self.check_exit)  # Associa o evento de pressionar a tecla Enter à função check_exit
        except Exception as e:
